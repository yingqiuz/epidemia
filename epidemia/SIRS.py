...
class SIRSAgents(AgentGroup):
    ...
    def region_clearance_step(self, clearance_rate=0):
        ...
        self.region_population[1, :] -= cleared
    ...
    def region_become_susceptible_step(self, scpt_rate):
        scpt = clearance_process_region(
            self.region_population[2, :], scpt_rate, self.dt
        )
        self.region_population[2, :] -= scpt
        self.region_population[0, :] += scpt
